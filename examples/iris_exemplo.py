#!/usr/bin/env python3
"""Exemplo com o dataset real Iris."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Treina a rede no dataset Iris")
    parser.add_argument("--epochs", type=int, default=160)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--save-dir", type=Path, default=Path("results/iris"))
    parser.add_argument("--no-plots", action="store_true")
    args = parser.parse_args()

    dataset = carregar_dataset("iris", seed=args.seed, samples=150)
